 ...
 * スタート地点を設定するコマンド
 */
public class CommandSetStartPos extends CommandBase {

    private static final String commandName = "unredstone_set_start_pos";

    public CommandSetStartPos() {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @Nullable String[] arguments) {
        ...
        try {
            ...
            sender.sendMessage("/unredstone_set_start_pos <team> <x> <y> <z>");
            return false;
        }
        ...
        // チームのスタート地点を設定
        AdminMenuRow1.onSetStartButton(sender, team, new Location(targetWorld, x, y, z));
        sender.sendMessage(teamText + " チームのスタート地点を設定しました！");
        return true;
    }
